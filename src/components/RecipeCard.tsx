...
export default function RecipeCard({
    ...
    return (
        <div className="bg-white max-w-md rounded-xl shadow-lg overflow-hidden border border-gray-200 text-gray-900">
            <div className="p-6">
                <div className="mb-4">
                ...
                <div className="mb-6 p-4 bg-gray-50 rounded-lg">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <span className="font-semibold text-lg min-w-[3rem] text-center text-gray-900">
                                {servings}
                            </span>
                            <button
                                onClick={() => handleServingsChange(servings + 1)}
