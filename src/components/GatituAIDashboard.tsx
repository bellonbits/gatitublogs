    ...
    return (
        <div className="flex h-[calc(100vh-80px)] w-full bg-[#09080b] text-[#d1d5db] overflow-hidden font-sans relative">
            ...
            <button
                ...
                className="lg:hidden absolute top-4 left-4 z-50 p-2 bg-white/5 border border-white/10 rounded-lg text-gray-400 hover:text-white transition-all shadow-xl backdrop-blur-md"
            >
            ...
            <main className="flex-1 relative flex flex-col p-4 sm:p-8 overflow-hidden bg-black pt-16 sm:pt-8">
                <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center px-4 mb-8 space-y-4 sm:space-y-0">
                    <div className="flex items-center space-x-2 bg-white/5 px-4 py-2 rounded-xl border border-white/5 hover:bg-white/10 cursor-pointer transition-all">
                        <span className="text-xs sm:text-sm font-medium">SCOUT ENGINE (8B Instant)</span>
                    ...
                    <div className="flex items-center space-x-3 w-full sm:w-auto overflow-x-auto pb-2 sm:pb-0 scrollbar-hide">
                        <button className="flex items-center space-x-2 bg-white/5 px-4 py-2 rounded-xl border border-white/5 hover:bg-white/10 transition-all text-xs sm:text-sm whitespace-nowrap">
                    ...
                    <div className="w-full max-w-4xl flex-1 flex flex-col">
                        {messages.length === 0 ? (
                            <div className="flex-1 flex flex-col items-center justify-center -mt-12">
                                ...
                                >
                                    <h1 className="text-3xl sm:text-5xl md:text-7xl font-bold text-white mb-4 tracking-tighter font-mono px-4">GATITU<span className="text-purple-500">.AI</span></h1>
                                    <p className="text-gray-500 font-mono text-[10px] sm:text-xs uppercase tracking-[0.2em] sm:tracking-[0.3em] px-4">Groq Direct Implementation // v5.0.0</p>
                                </motion.div>
